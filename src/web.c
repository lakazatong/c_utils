...
static size_t WriteMemoryCallback(void* response_content, size_t size,
...
// example:
// curl_request("GET", "https://osu.ppy.sh", "Connection: keep-alive",
// "Accept-Language: en-US,en;q=0.5") equivalent in python:
// requests.request('GET', 'https://osu.ppy.sh', headers={"Connection":
